...
namespace gsea {
    ...
    std::optional<std::string> ExpressionData::gene_name(size_t index) const {
    ...
    std::optional<std::string> ExpressionData::sample_name(size_t index) const {
    ...
    std::optional<double> ExpressionData::get_value(size_t gene_idx, size_t sample_idx) const {
